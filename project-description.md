...
Our aim is to train two to three models (e.g. one machine learning approach, one deep learning and one vector approach), evaluate the models and compare them with each other.
